...
| 2. Preproduction | In progress | Story beat sheet, timing map, technical architecture, data schemas, `docs/ART_BIBLE.md`, complete asset inventory, review templates | `docs/PREPRODUCTION_TRACEABILITY.md` defines the exit audit; supporting production documents are being reconciled |
