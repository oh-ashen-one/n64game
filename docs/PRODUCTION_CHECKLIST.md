...
|---|---|---|---|
| 1. Reference and legal audit | Complete | `docs/reference-study.md`; clean-room boundary; verified code/asset licenses; public hygiene baseline | Reference and toolchain pins audited; clean-room rules, separate licenses, notices, ignore/LFS rules, ledger template, secret scan, LFS attribute check, and large-file scan pass |
| 2. Preproduction | Not started | Story beat sheet, timing map, technical architecture, data schemas, `docs/ART_BIBLE.md`, complete asset inventory, review templates | — |
| 3. Toolchain | Not started | Pinned compatible dependencies, Docker/libdragon setup, clean ROM, Ares launch workflow, public CI artifact | Local audit shows Git LFS installed; Docker, libdragon CLI, Ares, and Blender are not installed |
...
- [x] Tiny3D/libdragon/Fast64/Ares toolchain audit recorded.
- [x] Pokémon XD opening pacing and clean-room functional mapping recorded.
- [x] Public-tree secret/large-file/license audit passes after Gate 1 documents are staged.
