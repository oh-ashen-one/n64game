#ifndef N64GAME_TEST_SUPPORT_ECHO_T3DSKELETON_H
#define N64GAME_TEST_SUPPORT_ECHO_T3DSKELETON_H
...
typedef struct { float values[16]; } T3DMat4FP;
typedef struct { int unused; } T3DBone;
